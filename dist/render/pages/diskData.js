...
// type: "HD"
// vendor: "Toshiba"
const renderFSData = (innerDiv) => {
    //<i class="fab fa-windows"></i>
    let fsOutput = ``;
    renderCards_1.os.FS.forEach((item, index) => {
        fsOutput += `
...
exports.renderFSData = renderFSData;
//# sourceMappingURL=diskData.js.map