...
const renderCPUdata = (innerDiv) => {
   ...
   <div class="times_core">
    ...
    <div class="wrapper_data_cpu_other">
        ...
        <div class="manufacturer_cpu">Manufacturer : ${renderCards_1.os.cpuData.manufacturer} <i class="fas fa-microchip"></i></div>
        <div class="model_cpu">Model :${renderCards_1.os.cpuData.model} <i class="fas fa-microchip"></i></div>
        <div class="physicalCores_cpu">Physical cores : ${renderCards_1.os.cpuData.physicalCores} <i class="fab fa-centercode"></i>  </div>

        <div class="speed_cpu">Current speed : ${renderCards_1.os.cpuData.speed} <i class="fas fa-tachometer-alt"></i></div>
        <div class="max_speed_cpu">Maximun speed : ${renderCards_1.os.cpuData.speedMax} <i class="fas fa-tachometer-alt"></i></div>
        <div class="min_speed_cpu">Minimum speed : ${renderCards_1.os.cpuData.speedMin} <i class="fas fa-tachometer-alt"></i></div>
        <div class="stepping_cpu">Stepping CPU: ${renderCards_1.os.cpuData.stepping} <i class="fas fa-shoe-prints"></i> </div>
        <div class="vendor_cpu">Vendor : ${renderCards_1.os.cpuData.vendor} <i class="fas fa-microchip"></i></div>
        <div class="virtualization_cpu">Virtualization : ${renderCards_1.os.cpuData.virtualization ? "Yes" : "No"} <i class="fas fa-microchip"></i></div>
    </div>
</div>
