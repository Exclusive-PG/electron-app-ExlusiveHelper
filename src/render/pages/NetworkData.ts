...
const checkEmpty = (object:any)=>{
    if(object === "" || object === null || object === undefined){
        return `Missing`
    }else return object;
}

export const renderNetworkData = (innerDiv:HTMLDivElement)=>{
    console.log(os.networkInterfaces);
    let networkDataRender:string = "";
    // carrierChanges: 0
    // dhcp: true
    // dnsSuffix: ""
    // duplex: ""
    ...
    os.networkInterfaces.forEach((item:any,index:number) => {
