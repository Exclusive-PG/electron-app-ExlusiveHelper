...
export const renderGPUdata = (innerDiv:HTMLDivElement)=>{

console.log(os.graphicsData.controllers[0])

    let controllers : string = "";

    os.graphicsData.controllers.forEach((item:any,index:any) => {
        controllers += 
...
// vendor: "(Standard monitor types)"
    ...
    os.graphicsData.displays.forEach((item:any,index:any) => {
